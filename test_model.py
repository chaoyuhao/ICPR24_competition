...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"/home/chaoyuhao/icpr/ICPR_JNU_MMD/runs/train/exp31/weights/best.pt",
                        help='model path(s)')
    ...
    parser.add_argument('--project', default=r'/data1/icpr/result', help='save to project/name')
